...
/*******************************************************************************
 * Instance třídy {@code Obdélník} představují obdélníky
 ...
 */
public class Obdélník implements IPohyb
{
//== KONSTANTNÍ ATRIBUTY TŘÍDY =================================================
    ...
    public static final Barva IMPLICITNÍ_BARVA = Barva.HNĚDÁ;
...
//== KONSTANTNÍ ATRIBUTY INSTANCÍ ==============================================
    ...
    private final String název = "Obdélník_" + ID;
...
//== OSTATNÍ NESOUKROMÉ METODY INSTANCÍ ========================================
    ...
    public void smaž()
    {
        ...
        PLÁTNO.zaplň(new java.awt.geom.Rectangle2D.Double
...
//== SOUKROMÉ A POMOCNÉ METODY INSTANCÍ ========================================
    ...
    private void nakresliPrivate()
    {
        ...
        PLÁTNO.zaplň(new java.awt.geom.Rectangle2D.Double(xPos, yPos, šířka, výška));
    }
